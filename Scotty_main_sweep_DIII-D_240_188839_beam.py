...
for ii, launch_freq_GHz in enumerate(launch_freqs_GHz):
    for jj, launch_beam_width_scaling in enumerate(launch_beam_width_scalings):
        for kk, launch_beam_curvature_scaling in enumerate(launch_beam_curvature_scalings):
            ...
            kwargs_dict['output_path'] = 'D:\\Dropbox\\VHChen2021\\Data - Scotty\\Run 17\\'
            ...
            counter = counter + 1
            print('Sweep completion:' + str(counter) + ' of ' + str( len(launch_freqs_GHz)*len(launch_beam_width_scalings)*len(launch_beam_curvature_scalings) ) )

np.savez(kwargs_dict['output_path'] + 'sweep_summary', 
