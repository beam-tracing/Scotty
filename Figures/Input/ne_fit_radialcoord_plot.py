...
plt.plot(ne_flux_output,linear_times_tanh(ne_flux_output,*popt),color='blue')
plt.plot(ne_flux_output,1.1*linear_times_tanh(ne_flux_output,*popt),color='red')
plt.ylim([0, 3.5])
plt.xlim([0, 1.0])
plt.ylabel('n_e / 10^19 kg m-3') # x-direction
plt.xlabel('psi_p')
