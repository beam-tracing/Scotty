        ...
        for kk, mirror_tilt in enumerate(mirror_tilts):
            for ll, launch_freq_GHz in enumerate(launch_freqs_GHz):
                for mm, mode_flag in enumerate([-1,1]):
                    ...
                    kwargs_dict['output_path'] = 'C:\\Dropbox\\VHChen2021\\Data - Scotty\\Run 27\\'
                    kwargs_dict['density_fit_parameters'] = None
                    kwargs_dict['ne_data_path'] = 'C:\\Dropbox\\VHChen2021\\Data - Equilibrium\MAST\\'
                    kwargs_dict['input_filename_suffix'] = '_CPS_Jon_avr_' + f'{equil_time*1000:.0f}' +'ms'
                    kwargs_dict['magnetic_data_path'] = 'C:\\Dropbox\\VHChen2021\\Data - Equilibrium\MAST\\'
