...
def find_x0(xs,ys,y0):
    """
    xs,ys are the x and y coordinates of a CURVE on a plane 
...
def find_area_points(xs,ys,fraction_wanted):
    ...
    total_ys               = integrate.simps(ys,xs) # can use last point of cumulative_ys
...
# Convert C10 C12 C14 using equations 66 - 71 in section 2.9
# Use the functions that valerian already made to test your conversion
#
#
