...
class outplot(object):
    ...
    def __init__(
        self, input_path="", suffix="", output_path=""
    ):
        # Path specifics
    ...
    if option == 0:
        ...
        for i in range(0, 2):
            ...
            width_XY = np.sqrt(
                ...
                / np.imag(
                    contract_special(
                        W_uvec_XY, contract_special(plotobject.Psi_3D_Cartesian, W_uvec_XY)
                    )
                )
            )
            ...
            plt.plot(
                plotobject.q_X_array[: plotobject.out_index], plotobject.q_Y_array[: plotobject.out_index], c=colour, label=name_tuple[i],
            )
            plt.plot(
                [launch_position_X, entry_position_X],
                [launch_position_Y, entry_position_Y],
        ...
        plt.figure()
        plt.plot(plotobject_1.l_lc, plotobject_1.poloidal_flux_output, c=colour_tup[0], label=name_tuple[0])
        plt.plot(plotobject_2.l_lc, plotobject_2.poloidal_flux_output, c=colour_tup[1], label=name_tuple[1])
        #plt.gca().set_aspect("equal", adjustable="box")
        plt.legend()
        ...
        plt.figure()
        plt.plot(plotobject_1.l_lc, plotobject_1.electron_density_output, c=colour_tup[0], label=name_tuple[0])
        plt.plot(plotobject_2.l_lc, plotobject_2.electron_density_output, c=colour_tup[1], label=name_tuple[1])
        # plt.gca().set_aspect("equal", adjustable="box")
        plt.legend()
        ...
        plt.figure()
        plt.plot(plotobject_1.l_lc, plotobject_2.temperature_output, c=colour_tup[0], label=name_tuple[0])
        plt.plot(plotobject_1.l_lc, plotobject_2.temperature_output, c=colour_tup[1], label=name_tuple[1])
        # plt.gca().set_aspect("equal", adjustable="box")
        plt.legend()
        ...
        for i in range(0,2):
            ...
            plt.subplot(1, 3, 3)
            plt.plot(plotobject.l_lc, plotobject.K_magnitude_array, c=colour, label=namelabel)
        ...
        for i in range(0,2):
            ...
            namelabel = name_tuple[i]
            plt.subplot(1, 3, 1)
            plt.plot(plotobject.l_lc, plotobject.b_hat_output[:, 0] * plotobject.B_magnitude, c=colour, label=namelabel)
            plt.subplot(1, 3, 2)
            plt.plot(plotobject.l_lc, plotobject.b_hat_output[:, 1] * plotobject.B_magnitude, c=colour, label=namelabel)
            plt.subplot(1, 3, 3)
            plt.plot(plotobject.l_lc, plotobject.b_hat_output[:, 2] * plotobject.B_magnitude, c=colour, label=namelabel)
        ...
        plt.subplot(2, 3, 1)
        plt.plot(plotobject_1.l_lc, np.real(plotobject_1.Psi_xx_output), "k", label=name_tuple[0], alpha=0.5)
        plt.plot(plotobject_1.l_lc, np.real(plotobject_1.M_xx_output), "r", label=name_tuple[0], alpha=0.5)
        plt.plot(plotobject_2.l_lc, np.real(plotobject_2.Psi_xx_output), "g", label=name_tuple[1], alpha=0.5)
        plt.plot(plotobject_2.l_lc, np.real(plotobject_2.M_xx_output), "b",label=name_tuple[1], alpha=0.5)
        plt.title(r"Re$(\Psi_{xx})$ and Re$(M_{xx})$")
        plt.xlabel(r"$l-l_c$")
        plt.legend()

        plt.subplot(2, 3, 2)
        plt.plot(plotobject_1.l_lc, np.real(plotobject_1.Psi_xy_output), "k", label=name_tuple[0], alpha=0.5)
        plt.plot(plotobject_1.l_lc, np.real(plotobject_1.M_xy_output), "r", label=name_tuple[0], alpha=0.5)
        plt.plot(plotobject_2.l_lc, np.real(plotobject_2.Psi_xy_output), "g", label=name_tuple[1], alpha=0.5)
        plt.plot(plotobject_2.l_lc, np.real(plotobject_2.M_xy_output), "b",label=name_tuple[1], alpha=0.5)
        plt.title(r"Re$(\Psi_{xy})$ and Re$(M_{xy})$")
        plt.xlabel(r"$l-l_c$")
        plt.legend()

        plt.subplot(2, 3, 3)
        plt.plot(plotobject_1.l_lc, np.real(plotobject_1.Psi_yy_output), "k", label=name_tuple[0], alpha=0.5)
        plt.plot(plotobject_2.l_lc, np.real(plotobject_2.Psi_yy_output), "g", label=name_tuple[1], alpha=0.5)
        plt.title(r"Re$(\Psi_{yy})$")
        plt.xlabel(r"$l-l_c$")
        plt.legend()

        plt.subplot(2, 3, 4)
        plt.plot(plotobject_1.l_lc, np.imag(plotobject_1.Psi_xx_output), "k", label=name_tuple[0], alpha=0.5)
        plt.plot(plotobject_1.l_lc, np.imag(plotobject_1.M_xx_output), "r", label=name_tuple[0], alpha=0.5)
        plt.plot(plotobject_2.l_lc, np.imag(plotobject_2.Psi_xx_output), "g", label=name_tuple[1], alpha=0.5)
        plt.plot(plotobject_2.l_lc, np.imag(plotobject_2.M_xx_output), "b",label=name_tuple[1], alpha=0.5)
        plt.title(r"Im$(\Psi_{xx})$ and Im$(M_{xx})$")
        plt.xlabel(r"$l-l_c$")
        plt.legend()

        plt.subplot(2, 3, 5)
        plt.plot(plotobject_1.l_lc, np.imag(plotobject_1.Psi_xy_output), "k", label=name_tuple[0], alpha=0.5)
        plt.plot(plotobject_1.l_lc, np.imag(plotobject_1.M_xy_output), "r", label=name_tuple[0], alpha=0.5)
        plt.plot(plotobject_2.l_lc, np.imag(plotobject_2.Psi_xy_output), "g", label=name_tuple[1], alpha=0.5)
        plt.plot(plotobject_2.l_lc, np.imag(plotobject_2.M_xy_output), "b",label=name_tuple[1], alpha=0.5)
        plt.title(r"Im$(\Psi_{xy})$ and Im$(M_{xy})$")
        plt.xlabel(r"$l-l_c$")
        plt.legend()

        plt.subplot(2, 3, 6)
        plt.plot(plotobject_1.l_lc, np.imag(plotobject_1.Psi_yy_output), "k", label=name_tuple[0], alpha=0.5)
        plt.plot(plotobject_2.l_lc, np.imag(plotobject_2.Psi_yy_output), "g", label=name_tuple[1], alpha=0.5)
        plt.tight_layout(pad=0.4, w_pad=0.5, h_pad=1.0)
        plt.title(r"Im$(\Psi_{yy})$")
        plt.xlabel(r"$l-l_c$")
        plt.legend()
        ...
        for i in range(0,2):
            ...
            colour = colour_tup[i]
            namelabel = name_tuple[i]
            plt.plot(plotobject.l_lc, -2 * plotobject.K_magnitude_array, c=colour, label="Bragg " + namelabel)
            plt.plot(plotobject.l_lc, plotobject.k_perp_1_bs, c=colour, label="Full Bragg " + namelabel)
        ...
        plt.subplot(1, 2, 1)
        plt.plot(plotobject_1.l_lc, plotobject_1.kappa_dot_xhat_output, c=colour_tup[0], label = name_tuple[0])
        plt.plot(plotobject_2.l_lc, plotobject_2.kappa_dot_xhat_output, c=colour_tup[1], label = name_tuple[1])
        plt.title(r"$\kappa \cdot \hat{x}$")

        plt.subplot(1, 2, 2)
        plt.plot(plotobject_1.l_lc, plotobject_1.kappa_dot_yhat_output, c=colour_tup[0], label = name_tuple[0])
        plt.plot(plotobject_2.l_lc, plotobject_2.kappa_dot_yhat_output, c=colour_tup[1], label = name_tuple[1])
        plt.title(r"$\kappa \cdot \hat{y}$")
        ...
        for i in range(0,2):
            ...
            plt.plot(
                plotobject.l_lc,
                -plotobject.xhat_dot_grad_bhat_dot_xhat_output * np.tan(plotobject.theta_output),
                label=r"$- \hat{x} \cdot \nabla \hat{b} \cdot \hat{x} \tan \theta$ " + namelabel,
            )
            plt.plot(
                plotobject.l_lc,
                (np.sin(plotobject.theta_output) / plotobject.g_magnitude_output) * plotobject.d_theta_d_tau,
            ...
            plt.plot(
                ...
                * plotobject.d_xhat_d_tau_dot_yhat_output,
                label=r"$d \hat{x} / d \tau \cdot \hat{y} \sin \theta \tan \theta / g$ " + namelabel,
            )
            plt.xlabel(r"$(l - l_c)$")
            plt.legend(loc="center left", bbox_to_anchor=(1, 0.5))
        ...
        for i in range(0,2):
            ...
            colour = colour_tup[i]
            namelabel = name_tuple[i]
            loc_m = np.exp(-2 * (plotobject.theta_m_output / plotobject.delta_theta_m) ** 2)
            plt.subplot(3, 2, 1)
            plt.title("mismatch")
            plt.plot(plotobject.l_lc, np.rad2deg(plotobject.theta_m_output), label=r"$\theta_m$ " + namelabel)
            plt.plot(plotobject.l_lc, np.rad2deg(plotobject.delta_theta_m), label=r"$\Delta \theta_m$ " + namelabel)
            plt.legend()
            plt.xlabel(r"$(l - l_c)$")
            plt.ylabel("deg")
            ...
            plt.subplot(3, 2, 4)
            plt.plot(plotobject.l_lc, plotobject.loc_b_r_s, label="loc_b_r_s " + namelabel)
            plt.xlabel(r"$(l - l_c)$")
            plt.legend()

            plt.subplot(3, 2, 5)
            plt.plot(plotobject.l_lc, plotobject.loc_b_r * loc_m, label="loc_b_m_r " + namelabel)
            plt.xlabel(r"$(l - l_c)$")
            plt.legend()

            plt.subplot(3, 2, 6)
            plt.plot(plotobject.l_lc, plotobject.loc_b_r_s * loc_m, label="loc_b_m_r_s " + namelabel)
            plt.xlabel(r"$(l - l_c)$")
            plt.legend()
        ...
        plt.figure()
        plt.title("H (Booker quartic)")
        plt.plot(plotobject_1.l_lc, plotobject_1.H_output, c=colour_tup[0], label=name_tuple[0])
        plt.plot(plotobject_2.l_lc, plotobject_2.H_output, c=colour_tup[1], label=name_tuple[1])
        ...
        for i in range(0,2):
            ...
            namelabel = name_tuple[i]
            plt.subplot(2, 3, 1)
            plt.plot(plotobject.l_lc, np.real(plotobject.Psi_xx_output), c=colour, label=namelabel)
            plt.plot(plotobject.l_lc, np.real(plotobject.M_xx_output), label=namelabel)
            plt.title(r"Re$(\Psi_{xx})$ and Re$(M_{xx})$")
            plt.xlabel(r"$l-l_c$")

            plt.subplot(2, 3, 2)
            plt.plot(plotobject.l_lc, np.real(plotobject.Psi_xy_output), c=colour, label=namelabel)
            plt.plot(plotobject.l_lc, np.real(plotobject.M_xy_output), label=namelabel)
            plt.title(r"Re$(\Psi_{xy})$ and Re$(M_{xy})$")
            plt.xlabel(r"$l-l_c$")

            plt.subplot(2, 3, 3)
            plt.plot(plotobject.l_lc, np.real(plotobject.Psi_yy_output), c=colour, label=namelabel)
            plt.title(r"Re$(\Psi_{yy})$")
            plt.xlabel(r"$l-l_c$")

            plt.subplot(2, 3, 4)
            plt.plot(plotobject.l_lc, np.imag(plotobject.Psi_xx_output), c=colour, label=namelabel)
            plt.plot(plotobject.l_lc, np.imag(plotobject.M_xx_output), label=namelabel)
            plt.title(r"Im$(\Psi_{xx})$ and Im$(M_{xx})$")
            plt.xlabel(r"$l-l_c$")

            plt.subplot(2, 3, 5)
            plt.plot(plotobject.l_lc, np.imag(plotobject.Psi_xy_output), c=colour, label=namelabel)
            plt.plot(plotobject.l_lc, np.imag(plotobject.M_xy_output), label=namelabel)
            plt.title(r"Im$(\Psi_{xy})$ and Im$(M_{xy})$")
            plt.xlabel(r"$l-l_c$")

            plt.subplot(2, 3, 6)
            plt.plot(plotobject.l_lc, np.imag(plotobject.Psi_yy_output), c=colour, label=namelabel)
            plt.tight_layout(pad=0.4, w_pad=0.5, h_pad=1.0)
            plt.title(r"Im$(\Psi_{yy})$")
            plt.xlabel(r"$l-l_c$")
        ...
        for i in range(0,2):
            ...
            colour = colour_tup[i]
            namelabel = name_tuple[i]
            plt.plot(plotobject.l_lc, np.rad2deg(plotobject.theta_output), label="theta " + namelabel)
            plt.plot(plotobject.l_lc, np.rad2deg(plotobject.theta_m_output), label="theta m " + namelabel)
            plt.plot(plotobject.l_lc, np.rad2deg(plotobject.delta_theta_m), label="delta theta m " + namelabel)
        plt.legend()
        plt.xlabel(r"$(l - l_c)$")
        plt.ylabel("deg")
        ...
        for i in range(0,2):
            ...
            plt.plot(plotobject.l_lc, factor, c=colour, label="-1 - theta / theta_m " + namelabel)
