...
class outplot(object):
    ...
    def plotout(self, option="all"):
        ...
        PLOTS = {
            "RZ trajectory": self.plot_RZ_trajectory,
            "XY trajectory": self.plot_XY_trajectory,
            "polflux": self.plot_polflux,
            "ne": self.plot_density,
            "K components": self.plot_k_components,
            "b_hat": self.plot_b_hat,
            "Psi_w and M_w": self.plot_Psi_w_M_w,
            "Backscattered turbulent k_perp": self.plot_backscattered_turbulent_k_perp,
            "Ray curvature": self.plot_ray_curvature,
            "Contributions to M_w": self.plot_M_w_contributions,
            "localisation weights": self.plot_localisation_weights,
            "H_bar": self.plot_H_bar,
            "mismatch": self.plot_mismatch,
            "Te": self.plot_temperature,
        }
        ...
        self.all_plots = [
            ...
            "b_hat",
            "Psi_w and M_w",
            "Backscattered turbulent k_perp",
            "Ray curvature",
        ]
    ...
    def plot_backscattered_turbulent_k_perp(self):
    ...
    def plot_M_w_contributions(self):
        plt.figure()
    ...
    def plot_localisation_weights(self):
