...
class outplot(object):
    ...
    def __init__(
        self, input_path="", suffix="", output_path="", relativistic_flag=False
    ):
        # Path specifics
...
def compare_plots(
    plotobject_1: outplot, plotobject_2: outplot, name_tuple: Tuple[str, ...], option=1
):
    """
    ...
    if option == 0:
        ...
        object_dict = {"plotobject_1": plotobject_1, "plotobject_2": plotobject_2}
        colour_tup = ("red", "blue")
        for i in (1, 2):
            name = name_tuple[i - 1]
