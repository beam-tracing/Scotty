...
def make_solver_events(
    ...
    def event_cross_resonance(tau, ray_parameters_2D, K_zeta, hamiltonian: Hamiltonian):
        ...
        difference = (gyro_freq-1)  #find the difference, if the sign changes, it means you have crossed the resonance frequency
        return difference
    ...
    def event_cross_resonance2(tau, ray_parameters_2D, K_zeta, hamiltonian: Hamiltonian):
        ...
        difference = (gyro_freq-0.5) #find the difference, if the sign changes, it means you have crossed the resonance frequency. 
