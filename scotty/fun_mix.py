...
def find_d2H_dKR_dR(q_R, q_Z, K_R, K_zeta, K_Z, launch_angular_frequency, mode_flag, delta_K_R, delta_R, 
    ...
    dH_dR_plus  = find_dH_dR(q_R, q_Z, K_R+delta_K_R, 
                         K_zeta, K_Z, launch_angular_frequency, mode_flag, delta_R, 
                         interp_poloidal_flux, find_density_1D, find_B_R, find_B_T, find_B_Z)
    dH_dR_minus = find_dH_dR(q_R, q_Z, K_R-delta_K_R, 
                         K_zeta, K_Z, launch_angular_frequency, mode_flag, delta_R, 
                         interp_poloidal_flux, find_density_1D, find_B_R, find_B_T, find_B_Z)
...
def find_d2H_dKR_dZ(q_R, q_Z, K_R, K_zeta, K_Z, launch_angular_frequency, mode_flag, delta_K_R, delta_Z, 
    ...
    dH_dZ_plus  = find_dH_dZ(q_R, q_Z, K_R+delta_K_R, 
                         K_zeta, K_Z, launch_angular_frequency, mode_flag, delta_Z, 
                         interp_poloidal_flux, find_density_1D, find_B_R, find_B_T, find_B_Z)
    dH_dZ_minus = find_dH_dZ(q_R, q_Z, K_R-delta_K_R, 
                         K_zeta, K_Z, launch_angular_frequency, mode_flag, delta_Z, 
                         interp_poloidal_flux, find_density_1D, find_B_R, find_B_T, find_B_Z)
...
def find_d2H_dKzeta_dR(q_R, q_Z, K_R, K_zeta, K_Z, launch_angular_frequency, mode_flag, delta_K_zeta, delta_R, 
    ...
    dH_dR_plus  = find_dH_dR(q_R, q_Z, K_R, K_zeta+delta_K_zeta, 
                         K_Z, launch_angular_frequency, mode_flag, delta_R, 
                         interp_poloidal_flux, find_density_1D, find_B_R, find_B_T, find_B_Z)
    dH_dR_minus = find_dH_dR(q_R, q_Z, K_R, K_zeta-delta_K_zeta, 
                         K_Z, launch_angular_frequency, mode_flag, delta_R, 
                         interp_poloidal_flux, find_density_1D, find_B_R, find_B_T, find_B_Z)
...
def find_d2H_dKzeta_dZ(q_R, q_Z, K_R, K_zeta, K_Z, launch_angular_frequency, mode_flag, delta_K_zeta, delta_Z, 
    ...
    dH_dZ_plus  = find_dH_dZ(q_R, q_Z, K_R, K_zeta+delta_K_zeta, 
                         K_Z, launch_angular_frequency, mode_flag, delta_Z, 
                         interp_poloidal_flux, find_density_1D, find_B_R, find_B_T, find_B_Z)
    dH_dZ_minus = find_dH_dZ(q_R, q_Z, K_R, K_zeta-delta_K_zeta, 
                         K_Z, launch_angular_frequency, mode_flag, delta_Z, 
                         interp_poloidal_flux, find_density_1D, find_B_R, find_B_T, find_B_Z)
...
def find_d2H_dKZ_dR(q_R, q_Z, K_R, K_zeta, K_Z, launch_angular_frequency, mode_flag, delta_K_Z, delta_R, 
    ...
    dH_dR_plus  = find_dH_dR(q_R, q_Z, K_R, K_zeta, K_Z+delta_K_Z, 
                         launch_angular_frequency, mode_flag, delta_R, 
                         interp_poloidal_flux, find_density_1D, find_B_R, find_B_T, find_B_Z)
    dH_dR_minus = find_dH_dR(q_R, q_Z, K_R, K_zeta, K_Z-delta_K_Z, 
                         launch_angular_frequency, mode_flag, delta_R, 
                         interp_poloidal_flux, find_density_1D, find_B_R, find_B_T, find_B_Z)
...
def find_d2H_dKZ_dZ(q_R, q_Z, K_R, K_zeta, K_Z, launch_angular_frequency, mode_flag, delta_K_Z, delta_Z, 
    ...
    dH_dZ_plus  = find_dH_dZ(q_R, q_Z, K_R, K_zeta, K_Z+delta_K_Z, 
                         launch_angular_frequency, mode_flag, delta_Z, 
                         interp_poloidal_flux, find_density_1D, find_B_R, find_B_T, find_B_Z)
    dH_dZ_minus = find_dH_dZ(q_R, q_Z, K_R, K_zeta, K_Z-delta_K_Z, 
                         launch_angular_frequency, mode_flag, delta_Z, 
                         interp_poloidal_flux, find_density_1D, find_B_R, find_B_T, find_B_Z)
