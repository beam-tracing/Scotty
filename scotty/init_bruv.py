...
from .fun_general import propagate_beam, propagate_circular_beam, find_nearest, genray_angles_from_mirror_angles
...
def get_parameters_for_Scotty(
    ...
    [ne_path, topfile_path, inbeam_path, 
     efitpp_path, UDA_saved_path] = user_settings(diagnostic,user,shot)    
        ...
        if shot == 29684:
            ...
            if find_ne_method == 'poly3':
                ...
                poloidal_fluxes_enter = np.array([
                                        1.14908613, 1.13336773, 
                                        1.13850717, 1.1274871 , 
                                        1.09851547, 1.1302204 , 
                                        1.15828467, 1.14394922, 
                                        1.1153502 , 1.13408871])
