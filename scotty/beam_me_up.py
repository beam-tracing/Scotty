...
def beam_me_up(
    ...
    delta_X: float = -0.0001,  # in the same units as K_z
    delta_Y: float = 0.0001,  # in the same units as K_z
    delta_K_X: float = 0.1,  # in the same units as K_z
    delta_K_Y: float = 0.1,  # in the same units as K_z
