...
for freq_GHz in freqs_GHz:
    for pol_launch_angle in pol_launch_angles:
        for tor_launch_angle in tor_launch_angles:
            ...
            kwargs_dict['output_path'] = 'D:\\Dropbox\\VHChen2021\\Data - Scotty\\Run 14\\'
            ...
            counter = counter + 1
            print('Sweep completion:' + str(counter) + ' of ' + str( len(freqs_GHz)*len(pol_launch_angles)*len(tor_launch_angles) ) )
