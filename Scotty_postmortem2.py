...
# plt.figure()
# plt.plot(tau_array[:stop_index],poloidal_flux_debugging_3R-poloidal_flux_output,'r')

# plt.figure()
# plt.plot(tau_array[:stop_index],B_total_output,'r')

# plt.figure()
# plt.subplot(1,3,1)
# plt.plot(tau_array[:stop_index],b_hat_output[:stop_index,0])
# plt.subplot(1,3,2)
# plt.plot(tau_array[:stop_index],b_hat_output[:stop_index,1])
# plt.subplot(1,3,3)
# plt.plot(tau_array[:stop_index],b_hat_output[:stop_index,2])


# plt.figure()
# plt.subplot(1,3,1)
# plt.plot(tau_array[:stop_index],epsilon_para_output)
# plt.subplot(1,3,2)
# plt.plot(tau_array[:stop_index],epsilon_perp_output)
# plt.subplot(1,3,3)
# plt.plot(tau_array[:stop_index],epsilon_g_output)

# plt.figure()
# plt.subplot(1,3,1)
# plt.plot(tau_array[:stop_index],det_imag_Psi_w_analysis)
# plt.subplot(1,3,2)
# plt.plot(tau_array[:stop_index],abs(det_M_w_analysis))
...
# #g_hat_Cartesian[:,0] = g_hat_output[:stop_index,0]*np.cos(q_zeta_array ) - g_hat_output[:stop_index,1]*np.sin(q_zeta_array )
# #g_hat_Cartesian[:,1] = g_hat_output[:stop_index,0]*np.sin(q_zeta_array ) + g_hat_output[:stop_index,1]*np.cos(q_zeta_array )
# #g_hat_Cartesian[:,2] = g_hat_output[:stop_index,2]
# #
# #plt.figure()
# #plt.plot(tau_array[:stop_index],Psi_imag_eigvec[:,0,0],'r')
# #plt.plot(tau_array[:stop_index],Psi_imag_eigvec[:,0,1],'g')
# #
# #plt.figure()
# #plt.plot(tau_array[:stop_index],y_hat_output[:stop_index,0],'r')
# #plt.plot(tau_array[:stop_index],y_hat_output[:stop_index,1],'g')
# #plt.plot(tau_array[:stop_index],y_hat_output[:stop_index,2],'b')
# #
# #plt.figure()
# #plt.plot(tau_array[:stop_index],g_hat_Cartesian[:,0],'r')
# #plt.plot(tau_array[:stop_index],g_hat_Cartesian[:,1],'g')
# #plt.plot(tau_array[:stop_index],g_hat_Cartesian[:,2],'b')